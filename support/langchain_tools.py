...
def check_delivery_status(tracking_number: str, carrier: str) -> dict:
    """Check current delivery status using tracking number and carrier.Use this when customer complains about delayed or missing order"""
    return _check_delivery_status(tracking_number, carrier)
# @tool
# def get_customer_risk_profile(user_id: int) -> dict:
#     """Get customer risk profile based on their order and refund history.Use this before making any refund decisions"""
